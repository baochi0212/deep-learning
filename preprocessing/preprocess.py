...
import string
import pandas as pd
from funcs import Vocab, normalize_funcs
import os
...
if __name__ == '__main__':
    #get data
    line_path = 'cornell movie-dialogs corpus/movie_lines.txt'
    conversation_path = 'cornell movie-dialogs corpus/movie_conversations.txt'
    csv_path = 'cornell movie-dialogs corpus/pair_df.csv'
