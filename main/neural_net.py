...
if __name__ == "__main__":
    ...
    #encode
    enc_output, enc_hidden  = encoder(sample_input.reshape(11, 32), lengths)
    ...
    encoder_hidden = repeat(enc_hidden[-1], 'b h -> n b h', n=decoder_n_layers)
    decoder_output, decoder_hidden = decoder(decoder_input, encoder_hidden, enc_output)
